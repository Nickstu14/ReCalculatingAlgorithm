...
{
public:
	Cell(Vector2 _Pos, Vector2 _Scale,/*int _PosX, int _PosY,*/ int _VecLoc, GameType _GT, string _fileName, ID3D11Device* _GD);
	~Cell();
	...
	void setGameType(GameType _GT) { m_GT = _GT; }
	GameType  getGameType() { return m_GT; }
